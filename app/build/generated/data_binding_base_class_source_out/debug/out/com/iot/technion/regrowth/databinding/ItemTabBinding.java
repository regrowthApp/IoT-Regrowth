...
public final class ItemTabBinding implements ViewBinding {
  ...
  private ItemTabBinding(@NonNull ConstraintLayout rootView, @NonNull ImageView animalIcon,
      @NonNull TextView animalName, @NonNull ConstraintLayout itemRoot) {
  ...
  public static ItemTabBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      id = R.id.animalIcon;
      ImageView animalIcon = ViewBindings.findChildViewById(rootView, id);
      if (animalIcon == null) {
        break missingId;
      }
      ...
      return new ItemTabBinding((ConstraintLayout) rootView, animalIcon, animalName, itemRoot);
    }
