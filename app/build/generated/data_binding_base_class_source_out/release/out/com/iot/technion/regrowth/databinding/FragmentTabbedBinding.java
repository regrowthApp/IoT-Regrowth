...
public final class FragmentTabbedBinding implements ViewBinding {
  ...
  @NonNull
  public final ClickablePieChart activityChart;

  @NonNull
  public final BarChart animalsChart;

  @NonNull
  public final ClickablePieChart heatChart;
  ...
  @NonNull
  public final ClickablePieChart weightChart;

  private FragmentTabbedBinding(@NonNull ScrollView rootView, @NonNull TextView Activity,
      @NonNull TextView HeatStress, @NonNull TextView Weight,
      @NonNull ClickablePieChart activityChart, @NonNull BarChart animalsChart,
      @NonNull ClickablePieChart heatChart, @NonNull Guideline horizontalLine0,
      ...
      @NonNull TableLayout nodesTable, @NonNull TableRow tableRowHeading,
      ...
      @NonNull Guideline verticalLine9, @NonNull ClickablePieChart weightChart) {
  ...
  public static FragmentTabbedBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      ClickablePieChart activityChart = ViewBindings.findChildViewById(rootView, id);
      ...
      id = R.id.heat_chart;
      ClickablePieChart heatChart = ViewBindings.findChildViewById(rootView, id);
      if (heatChart == null) {
        break missingId;
      }
      ...
      ClickablePieChart weightChart = ViewBindings.findChildViewById(rootView, id);
      if (weightChart == null) {
        break missingId;
      }
