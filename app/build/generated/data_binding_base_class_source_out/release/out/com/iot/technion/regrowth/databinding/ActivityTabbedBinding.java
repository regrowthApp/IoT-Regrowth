...
public final class ActivityTabbedBinding implements ViewBinding {
  ...
  @NonNull
  public final BottomNavigationView topBar;

  @NonNull
  public final ViewPager2 viewPager;

  private ActivityTabbedBinding(@NonNull ConstraintLayout rootView,
      @NonNull AppBarLayout appBarLayout, @NonNull TabLayout tabs,
      @NonNull BottomNavigationView topBar, @NonNull ViewPager2 viewPager) {
  ...
  public static ActivityTabbedBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.top_bar;
      BottomNavigationView topBar = ViewBindings.findChildViewById(rootView, id);
      if (topBar == null) {
        break missingId;
      }
      ...
      return new ActivityTabbedBinding((ConstraintLayout) rootView, appBarLayout, tabs, topBar,
          viewPager);
    }
